<?php
    ...
    $username=$_SESSION['emplogin'];
        $sql ="SELECT Password FROM club_members WHERE EmailId=:username and Password=:password";
    ...
    $con="UPDATE club_members set Password=:newpassword where EmailId=:username";
    ...
    $msg="Passwords are not matching.. Please enter same password in confirm password too..";
} }
