<?php
    ...
    $sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Phonenumber=:mobileno where EmailId=:eid";
    ...
    <div class="page-container">
            ...
            <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="#">
                                <a href="roomse.php" aria-expanded="true"><i class="ti-home"></i><span>Rooms
                                    </span></a>
                            </li>
                            <li class="#">
        ...
        <div class="row align-items-center">
                    ...
                    <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Edit  My  Profile</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="indtry.php">Home</a></li>
                                <li><span>View My Profile</span></li>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php 
                                            $eid=$_SESSION['emplogin'];
                                            $sql = "SELECT * from  club_members where EmailId=:eid";
                                            $query = $dbh -> prepare($sql);
                                            $query -> bindParam(':eid',$eid, PDO::PARAM_STR);
                                            $query->execute();
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="firstName" value="<?php echo htmlentities($result->FirstName);?>" readonly type="text" required id="example-text-input">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="mobileno" type="tel" value="<?php echo htmlentities($result->Phonenumber);?>" readonly maxlength="10" autocomplete="off" required>
                                        </div>
