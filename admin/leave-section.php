<?php
    ...
    if(isset($_GET['del'])){
    $id=$_GET['del'];
    $sql = "DELETE from  club_type  WHERE id=:id";
    $query = $dbh->prepare($sql);
    $query -> bindParam(':id',$id, PDO::PARAM_STR);
    $query -> execute();
    $msg="Club type record deleted";
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-leavetype.php" class="btn btn-sm btn-info">Add New Club Type</a></center>
                                    <table id="dataTable3" class="table table-hover table-striped text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->ClubType);?></td>
                                            <td><?php echo htmlentities($result->ClubName);?></td>
