                                ...
                                <center><a href="add-admin.php" class="btn btn-sm btn-info">Add New Administrator</a></center>
                                    ...
                                    {               ?>  
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->Se_id);?></td>
                                            <td><?php echo htmlentities($result->addedby);?></td>
                                            <td><a href="update-admin.php?id=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" style="color:green"></i></a><a href="manage-admin.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to Delete?');"> <i class="fa fa-trash" style="color:red"></i></a></td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                    </table>
