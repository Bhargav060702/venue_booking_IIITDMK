<?php
    ...
    $sql="INSERT INTO club_members(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Phonenumber,p_email,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:mobileno,:p_email,:status)";
    ...
    $query->bindParam(':p_email',$p_email,PDO::PARAM_STR);
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Add Member Section</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="employees.php">Member</a></li>
                                <li><span>Add</span></li>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted font-14 mb-4">Please fill up the form in order to add member records</p>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Institute ID</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Personal Email</label>
                                            <input class="form-control" name="p_email" type="text"   autocomplete="off" >
                                        </div>

                                        
                                        <h4>Set Password for Member Login</h4>
