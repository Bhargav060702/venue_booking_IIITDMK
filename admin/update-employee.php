<?php
    ...
    $sql="UPDATE club_members set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Phonenumber=:mobileno, EmailId=:email, p_email=:p_email where id=:eid";
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Update Member Section</h4>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php 
                                            $eid=intval($_GET['empid']);
                                            $sql = "SELECT * from  club_members where id=:eid";
                                            $query = $dbh -> prepare($sql);
                                            $query -> bindParam(':eid',$eid, PDO::PARAM_STR);
                                            $query->execute();
