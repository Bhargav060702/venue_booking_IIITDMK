...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Profile</strong><small> Form</small></div>
                           ...
                           <form method="post">
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<input type="password"  name="password" placeholder="Enter employee password" class="form-control" required disabled>
								</div>
								<div class="form-group">
									...
									<select name="department_id" required class="form-control">
										...
										while($row=mysqli_fetch_assoc($res)){
											if($department_id==$row['id']){
												...
												echo "<option value disabled=".$row['id'].">".$row['department']. "</option>";
											}
										}
										?>
									</select>
