<?php
    ...
    $sql="INSERT INTO admin(fullname,email,Se_id,Password,UserName,addedby) VALUES(:fullname,:email,:Se_id,:password,:username,:name)";
    $query = $dbh->prepare($sql);
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Modification by</label>
                                            <input class="form-control" name="addedby" type="text" value="<?php echo htmlentities($results->UserName);?>"  autocomplete="off" disabled>
                                        </div>
