<nav>
        ...
        <li class="<?php if($page=='member') {echo 'active';} ?>"><a href="employees.php"><i class="ti-id-badge"></i> <span>Club Members Section</span></a></li>
        ...
        <li class="<?php if($page=='department') {echo 'active';} ?>"><a href="department.php"><i class="fa fa-th-large"></i> <span>Department Section</span></a></li>
         ...
         <li class="<?php if($page=='club') {echo 'active';} ?>"><a href="leave-section.php"><i class="fa fa-sign-out"></i> <span>Club Types</span></a></li>

        <li class="<?php if($page=='manage-leave') {echo 'active';} ?>">
            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-briefcase"></i><span>Monitor Booking</span></a>

            <ul class="collapse">
                <li ><a href="pending-history.php"><i class="fa fa-spinner"></i> Pending</a></li>
                <li ><a href="recommended-history.php"><i class="fa fa-check"></i> Recommended</a></li>
                ...
                <li ><a href="leave-history.php"><i class="fa fa-history"></i> Booking History</a></li>
            </ul>
